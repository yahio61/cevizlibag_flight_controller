 ...
 ***************************************************/
/* active information */
#define EXT_FLASH_PAGE_SIZE     0x0100      // 256 B  (page size)
#define EXT_FLASH_SECTOR_SIZE   0x1000      // 4 KB   (sector size)
#define EXT_FLASH_BLOCK_SIZE    0x00010000  // 64 KB  (block size)
#define EXT_FLASH_SIZE          0x02000000  // 32 MB  (total size)
#define EXT_FLASH_PAGE_NUM      0x20000     // 131072 pages
#define EXT_FLASH_SECTOR_NUM    0x2000      // 8192 sectors
#define EXT_FLASH_BLOCK_NUM     0x200       // 512 blocks
